...
try: 
response = requests.get(links[x], headers=header, timeout=15) # Added a timeout for 
robustness 
...
file.write('<head><meta charset="utf-8"><meta name="viewport" content="width=device
...
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample"   role="button" aria-expanded="false" aria
controls="collapseExample">VeryWell Mind</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample1"  role="button" aria-expanded="false" aria
controls="collapseExample">Psychology Today</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample2"  role="button" aria-expanded="false" aria
controls="collapseExample">Scientific American</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample3"  role="button" aria-expanded="false" aria
controls="collapseExample">The National Institute of Mental Health (NIMH)</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample4"  role="button" aria-expanded="false" aria
controls="collapseExample">APA PsyPort</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample5"  role="button" aria-expanded="false" aria
controls="collapseExample">APA Monitor</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample6"  role="button" aria-expanded="false" aria
controls="collapseExample">Google Notícias</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample7"  role="button" aria-expanded="false" aria
controls="collapseExample">SBP</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample8"  role="button" aria-expanded="false" aria
controls="collapseExample">Neuroscience</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample9"  role="button" aria-expanded="false" aria
controls="collapseExample">Positive Psichology</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample10"  role="button" aria-expanded="false" aria
controls="collapseExample">Positive Psychcentral</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample11"  role="button" aria-expanded="false" aria
controls="collapseExample">IQ`s Corner</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample12"  role="button" aria-expanded="false" aria
controls="collapseExample">Happier Human</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample13"  role="button" aria-expanded="false" aria
controls="collapseExample">PsyNewsDaily</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample14"  role="button" aria-expanded="false" aria
controls="collapseExample">Psychiatric Times</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample15"  role="button" aria-expanded="false" aria
controls="collapseExample">APS</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample16"  role="button" aria-expanded="false" aria
controls="collapseExample">CFP</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample17"  role="button" aria-expanded="false" aria
controls="collapseExample">Psicologia USP</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample18"  role="button" aria-expanded="false" aria
controls="collapseExample">Conselho Regional de Psicologia SP</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample19"  role="button" aria-expanded="false" aria
controls="collapseExample">El País Psicologia</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample20"  role="button" aria-expanded="false" aria
controls="collapseExample">G1 Saúde Mental</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample21"  role="button" aria-expanded="false" aria
controls="collapseExample">Medical Xpress</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample22"  role="button" aria-expanded="false" aria
controls="collapseExample">Psychreg</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample23"  role="button" aria-expanded="false" aria
controls="collapseExample">Folha Equilíbrio Mente</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample24"  role="button" aria-expanded="false" aria
controls="collapseExample">PsychCrunch</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample25"  role="button" aria-expanded="false" aria
controls="collapseExample">A Mente é Maravilhosa-Neurociência</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample26"  role="button" aria-expanded="false" aria
controls="collapseExample">A Mente é Maravilhosa-Psicologia</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample27"  role="button" aria-expanded="false" aria
controls="collapseExample">A Mente é Maravilhosa-Relações</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample28"  role="button" aria-expanded="false" aria
controls="collapseExample">A Mente é Maravilhosa-Saúde</a>') 
file.write('<a class="btn btn-space btn-outline-info btn-lg" data-toggle="collapse" 
href="#collapseExample29"  role="button" aria-expanded="false" aria
controls="collapseExample">Big Think</a>') 
file.write('</p>') 
file.close() 
...
for z in x.find_all("a"): 
file.write("<a href="+ "https://www.scientificamerican.com"+ 
z.get("href")+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#NIHM 
file = open(namefile,"a") 
...
file.write("<a href="+ "https://www.nimh.nih.gov"+ 
z.get("href")+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#APA PsyPort 
...
file.write("<a href="+ 
"https://www.apa.org"+str(n.get("href"))+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#Google Notícias 
file = open(namefile,"a") 
...
file.write("<a href="+ 
"https://news.google.com"+str(z.get("href"))+">"+x.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
...
for n in z.find_all("a"): 
file.write("<a href="+ 
"https://www.sbponline.org.br"+str(n.get("href"))+">"+n.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#Neuroscience 
file = open(namefile,"a") 
...
for z in x.find_all("a"): 
file.write("<a href="+ 
"https://psychcentral.com/"+str(z.get("href"))+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#IQ`s Corner 
file = open(namefile,"a") 
...
file.write("<a href="+ 
"https://www.psychiatrictimes.com/"+str(x.get("href"))+">"+z.text+"</a>"+"</br>") # 
Changed z.get("href") to x.get("href") 
file.write("</div></div>") 
file.close() 
#APS 
file = open(namefile,"a") 
...
for z in x.find_all("h3"): 
file.write("<a href="+ 
"https://www.scielo.br"+str(x.get("href"))+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
...
for z in x.find_all("a"): 
file.write("<a href="+ 
"https://brasil.elpais.com/"+str(z.get("href"))+">"+z.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
#G1 Saúde 
file = open(namefile,"a") 
...
for x in parser[25].find_all("a",class_="jsx-151512268 jsx-1424224867 default-a-link global
link jsx-3363598852"): 
file.write("<a href="+ 
"https://amenteemaravilhosa.com.br"+str(x.get("href"))+">"+x.text+"</a>"+"</br>") 
file.write("</div></div>") 
file.close() 
...
for x in parser[26].find_all("a",class_="jsx-151512268 jsx-1424224867 default-a-link global
link jsx-3363598852"): 
file.write("<a href="+ 
"https://amenteemaravilhosa.com.br"+str(x.get("href"))+">"+x.text+"</a>"+"</br>") 
file.write("</div></div>") 
...
for x in parser[27].find_all("a",class_="jsx-151512268 jsx-1424224867 default-a-link global
link jsx-3363598852"): 
file.write("<a href="+ 
"https://amenteemaravilhosa.com.br"+str(x.get("href"))+">"+x.text+"</a>"+"</br>") 
file.write("</div></div>") 
...
for x in parser[28].find_all("a",class_="jsx-151512268 jsx-1424224867 default-a-link global
link jsx-3363598852"): 
file.write("<a href="+ 
"https://amenteemaravilhosa.com.br"+str(x.get("href"))+">"+x.text+"</a>"+"</br>") 
file.write("</div></div>") 
